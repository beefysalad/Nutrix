          ...
          {dailyReportQuery.isLoading ? (
            ...
            <>
              <div className="grid grid-cols-2 gap-4">
                <div className="col-span-2 flex flex-col items-center justify-center rounded-3xl border border-[#e4ff00]/10 bg-[#e4ff00]/5 py-8 text-center shadow-2xl sm:col-span-1 sm:items-start sm:px-8 sm:py-6 sm:text-left">
                ...
                <div className="col-span-2 grid grid-cols-3 gap-3 sm:col-span-1">
                  <div className="flex flex-col items-center justify-center rounded-2xl border border-white/5 bg-[#1a1a1a] p-4 text-center">
